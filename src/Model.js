...
export default function Model(props) {
  ...
  console.log(`TCL>>> ~ file: Model.js ~ line 10 ~ Model ~ materials`, materials)
  console.log(`TCL>>> ~ file: Model.js ~ line 10 ~ Model ~ nodes`, nodes)
  return (
    <group ref={group} {...props} dispose={null}>
      <group rotation={[-Math.PI / 0.1, 0.3, 0.1]} scale={[0.1, 0.1, 0.1]}>
        <group /* rotation={[Math.PI / 2, 0, 0]} */>
         ...
         {/*  <group position={[-1018.2, -380.53, 1332.67]} rotation={[-1.05, 0.72, -0.08]} scale={[100, 100, 100]}>
          ...
          {/* <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_4.geometry} />
          </group> */}
         {/*  <group scale={[100, 100, 100]}>
          ...
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_0.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_1.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_2.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_3.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_4.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_5.geometry} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={[100, 100, 100]}>
            <mesh material={materials.RockBake} geometry={nodes.mesh_6.geometry} />
          </group>
        </group>
      </group>
    </group>
